...
OBJDIR_PROFILE = .obj/Profile/helloworld
DEP_PROFILE = 
OUT_PROFILE = ./bin/Profile/helloworld
...
OBJDIR_DEBUG = .obj/Debug/helloworld
DEP_DEBUG = 
OUT_DEBUG = ./bin/Debug/helloworld
...
OBJDIR_RELEASE = .obj/Release/helloworld
DEP_RELEASE = 
OUT_RELEASE = ./bin/Release/helloworld

OBJ_PROFILE = $(OBJDIR_PROFILE)/src/helloworld.o
OBJ_DEBUG = $(OBJDIR_DEBUG)/src/helloworld.o
OBJ_RELEASE = $(OBJDIR_RELEASE)/src/helloworld.o
...
$(OBJDIR_PROFILE)/src/helloworld.o: src/helloworld.c
	test -d $(OBJDIR_PROFILE)/src || mkdir -p $(OBJDIR_PROFILE)/src
	$(CC) $(CFLAGS_PROFILE) $(INC_PROFILE) -c -o $(OBJDIR_PROFILE)/src/helloworld.o src/helloworld.c
...
$(OBJDIR_DEBUG)/src/helloworld.o: src/helloworld.c
	test -d $(OBJDIR_DEBUG)/src || mkdir -p $(OBJDIR_DEBUG)/src
	$(CC) $(CFLAGS_DEBUG) $(INC_DEBUG) -c -o $(OBJDIR_DEBUG)/src/helloworld.o src/helloworld.c
...
$(OBJDIR_RELEASE)/src/helloworld.o: src/helloworld.c
	test -d $(OBJDIR_RELEASE)/src || mkdir -p $(OBJDIR_RELEASE)/src
	$(CC) $(CFLAGS_RELEASE) $(INC_RELEASE) -c -o $(OBJDIR_RELEASE)/src/helloworld.o src/helloworld.c
