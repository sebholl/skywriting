...
OBJDIR_PROFILE = .obj/Profile/fib
DEP_PROFILE = 
OUT_PROFILE = ./bin/Profile/fib
...
OBJ_PROFILE = $(OBJDIR_PROFILE)/src/fib.o
...
$(OBJDIR_PROFILE)/src/fib.o: src/fib.c
	test -d $(OBJDIR_PROFILE)/src || mkdir -p $(OBJDIR_PROFILE)/src
	$(CC) $(CFLAGS_PROFILE) $(INC_PROFILE) -c -o $(OBJDIR_PROFILE)/src/fib.o src/fib.c
